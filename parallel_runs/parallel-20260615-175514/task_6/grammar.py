...
request = requests.Request([
    ...
    primitives.restler_static_string("users"),
    primitives.restler_static_string("/"),
    primitives.restler_custom_payload("userId", quoted=False),
    primitives.restler_static_string("?"),
    primitives.restler_static_string("context="),
    primitives.restler_fuzzable_group("context", ['view','embed','edit'] , default_enum="view" ,quoted=False),
    primitives.restler_static_string("&"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("&"),
    primitives.restler_static_string("reassign="),
    primitives.restler_custom_payload_query("reassign", quoted=False),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: 192.168.65.128:8088\r\n"),
    primitives.restler_refreshable_authentication_token("authentication_token_tag"),
