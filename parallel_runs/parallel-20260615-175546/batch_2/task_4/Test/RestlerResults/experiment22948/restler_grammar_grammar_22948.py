...
request = requests.Request([
    ...
    primitives.restler_static_string("settings"),
    primitives.restler_static_string("/"),
    primitives.restler_custom_payload("settingId", quoted=False),
    primitives.restler_static_string("?"),
    primitives.restler_static_string("context="),
    primitives.restler_custom_payload_query("context", quoted=False),
    primitives.restler_static_string("&"),
    primitives.restler_static_string("_embed="),
    primitives.restler_custom_payload_query("_embed", quoted=False),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: 192.168.65.128:8088\r\n"),
    primitives.restler_static_string("Accept-Language: "),
